view: Internet_Sales_Cube {
  ...
  measure: m_Calculated_Tax_distinct {
    label: "Calculated Tax - TEST"
    value_format: "#.####"
    type: count_distinct
    sql: ${TABLE}.`m_Calculated Tax_distinct`;;
  }
  ...
  measure: m_Test___2_distinct {
    label: "Row Count - DC"
    value_format: "#.####"
    type: count_distinct
    sql: ${TABLE}.`m_Test - 2_distinct`;;
  }

  measure: m_Test___2_sum {
    label: "Test   2 - SUM"
    type: sum
    sql: ${TABLE}.`m_Test - 2_sum`;;
  }
